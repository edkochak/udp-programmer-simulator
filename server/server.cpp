...
class ProgrammersServer {
   private:
    ...
    std::map<int, std::pair<std::string, int>> programmer_addresses;
    std::map<int, std::pair<std::string, int>> observer_addresses;
